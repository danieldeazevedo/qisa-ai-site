  ...
  return (
    <div className="min-h-screen relative overflow-hidden text-foreground">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-100/80 via-purple-100/60 to-pink-100/80 dark:from-blue-900/40 dark:via-purple-900/30 dark:to-pink-900/40"></div>
        <div className="absolute inset-0 bg-gradient-to-tl from-cyan-50/60 via-indigo-50/40 to-rose-50/60 dark:from-cyan-900/30 dark:via-indigo-900/20 dark:to-rose-900/30"></div>
        
        {/* Floating gradient orbs with enhanced animations and stronger colors */}
        <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-gradient-to-br from-blue-400/25 to-purple-400/20 rounded-full blur-3xl animate-gradient-flow"></div>
        <div className="absolute top-1/3 right-0 w-[400px] h-[400px] bg-gradient-to-bl from-purple-400/22 to-pink-400/25 rounded-full blur-3xl animate-float" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-0 left-1/4 w-[350px] h-[350px] bg-gradient-to-tr from-pink-400/25 to-blue-400/20 rounded-full blur-3xl animate-drift" style={{animationDelay: '4s'}}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-gradient-to-r from-blue-300/15 via-purple-300/20 to-pink-300/15 rounded-full blur-2xl animate-spin" style={{animationDuration: '30s'}}></div>
        
        {/* Additional moving elements with stronger presence */}
        <div className="absolute top-3/4 right-1/4 w-[280px] h-[280px] bg-gradient-to-bl from-indigo-400/20 to-cyan-400/18 rounded-full blur-2xl animate-float" style={{animationDelay: '6s', animationDuration: '18s'}}></div>
        <div className="absolute top-1/4 left-3/4 w-[240px] h-[240px] bg-gradient-to-tr from-rose-400/22 to-orange-400/20 rounded-full blur-3xl animate-drift" style={{animationDelay: '1s', animationDuration: '22s'}}></div>
        <div className="absolute bottom-1/3 right-1/3 w-[320px] h-[320px] bg-gradient-to-bl from-violet-400/18 to-fuchsia-400/22 rounded-full blur-3xl animate-gradient-flow" style={{animationDelay: '8s', animationDuration: '25s'}}></div>
        
        {/* Overlay to maintain readability */}
        <div className="absolute inset-0 bg-background/75 dark:bg-background/80"></div>
      </div>
